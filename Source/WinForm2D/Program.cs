...
namespace WinForm2D
{
    ...
    {
        //Achtung: Unter Windows 10 gibt es unter den Anzeigeeinstellungen "Skalierung und Anordnung - Größe von Text, Apps und anderen Elementen ändern = 150% (empfohlen)"
